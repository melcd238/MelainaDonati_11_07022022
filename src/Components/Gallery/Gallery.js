...
function Gallery (props){
    ...
    return(
        <div className={classes.gallery} style={{backgroundImage:  `url(${currentPicture})`}}>
            ...
            <div>
                {arrayNumber ? "" : <img src={left} alt="fleche gauche" className={classes.arrow} style={{marginLeft : "22px"}} onClick = {(e)=>HandlePrevPicture(e)}/> }
            </div>
            ...
            <div>
               {arrayNumber ? "" : <img src={right} alt="fleche gauche" className={classes.arrow} style={{marginRight : "22px" }} onClick = {(e)=> HandleNextPicture(e)} /> }
            </div>
        </div>
    )
}
